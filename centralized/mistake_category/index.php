...
<head lang="ja">
	...
	<title>Mistake Category Management</title>
...
<body>
	...
	?>
	<div class="panel panel-danger dash-board">
		<div class="panel-heading">
			<h3 class="panel-title">Mistake Category Management</h3>
		</div>
		<div class="panel-body">
			<?php require_once 'ui/table.php';?>
		</div>
		<div class="panel-footer">
			<button id="mistake-category-add" class="btn btn-danger">Add New</button>
		</div>
	</div>
