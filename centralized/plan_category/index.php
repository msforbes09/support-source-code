...
<body>
	...
	?>
	<div class="panel panel-success dash-board">
		<div class="panel-heading">
			<h3 class="panel-title">Plan Category Management</h3>
		</div>
		<div class="panel-body">
			<?php require_once 'ui/table.php';?>
		</div>
		<div class="panel-footer">
			<button id="plan-category-add" class="btn btn-success">Add New</button>
		</div>
	</div>
